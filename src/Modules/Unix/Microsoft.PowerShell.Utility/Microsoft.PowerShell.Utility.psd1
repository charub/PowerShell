...
CmdletsToExport= "Format-List", "Format-Custom", "Format-Table", "Format-Wide",
    ...
    "Get-RunspaceDebug", "Wait-Debugger" , "Get-Uptime", "New-TemporaryFile", "Get-Verb","Get-EnvironmentVariable", "Set-EnvironmentVariable",
    "New-EnvironmentVariable", "Add-EnvironmentVariable", "Remove-EnvironmentVariable"
FunctionsToExport= "Format-Hex", "Import-PowerShellDataFile"
AliasesToExport= "fhx"
